/* 
//Funcion constructura (para luego usarlo)
function Personaje(nombre,apellido,edad){
    this.nombre = nombre;
    this.apellido = apellido;
    this.edad = edad;
    //metodo↓ (propio de objetos (personaje))
    this.hablar = function(){console.log('Hola soy '+this.nombre)}

}
const personaje3 = new Personaje('Bart', 'Simpson', 10)
//Puedo llamar individualmente (console.log(personaje3.nombre);)
console.log(personaje3.hablar()); 

//Operador in
//console.log('nombre' in personaje3);//True
//console.log('color de pelo' in personaje3);//False
...
const arrayVacio = [];
const carrito = ['pizza hawaiana', 'faina', 'birra'];
...
{nombre:'Cristian', apellido:'Salazar'}];
